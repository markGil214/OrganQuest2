...
const TeacherDashboard = () => {
  ...
  // Open student modal for a specific class
  ...
  // Get the currently selected class for the student list modal
                    ...
                    <tr key={cls.id}>
                      ...
                      <td className="px-4 py-2 border-b flex gap-2">
                        <button
                          ...
                          onClick={() => handleOpenStudentModal(cls.id)}
                        >
                          View Students / Add
                        </button>
                      </td>
