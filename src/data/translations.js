...
export const translations = {
  ...
  scanExplore: {
    english: {
      ...
      chooseOrgan: 'Choose Your Organ!',
      tapDiscover: 'Tap to discover amazing facts!',
      backToMenu: 'Back to Menu',
      scanningBody: 'Scanning Your Body...',
      findingOrgans: 'Finding all the amazing organs!',
      meetYour: 'Meet Your',
      didYouKnow: 'Did You Know?',
      exploreInAR: 'Explore',
      exploreCrossSection: 'Explore Cross Section',
      organExpert: 'Organ Expert!',
      exploredAll: 'You explored all the organs!',
    ...
    filipino: {
      ...
      chooseOrgan: 'Pumili ng Iyong Organ!',
      tapDiscover: 'I-tap upang tuklasin ang mga kahanga-hangang katotohanan!',
      backToMenu: 'Bumalik sa Menu',
      scanningBody: 'Sine-scan ang Iyong Katawan...',
      findingOrgans: 'Hinahanap ang lahat ng kahanga-hangang organ!',
      meetYour: 'Kilalanin ang Iyong',
      didYouKnow: 'Alam Mo Ba?',
      exploreInAR: 'Tuklasin',
      exploreCrossSection: 'Tuklasin ang Cross Section',
      organExpert: 'Dalubhasa sa Organ!',
      exploredAll: 'Tuklas mo na ang lahat ng organ!',
      achievementUnlocked: 'Tagumpay na Nakamit!',
      arScanner: 'AR Scanner',
