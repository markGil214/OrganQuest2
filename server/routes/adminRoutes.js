...
// @route   POST /api/admin/migrate-user-ids
// @desc    Run user ID migration (temporary endpoint)
// @access  Admin only
router.post('/migrate-user-ids', authMiddleware, adminMiddleware, async (req, res) => {
  try {
    console.log('=== RUNNING USER ID MIGRATION ===');
